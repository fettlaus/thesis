...
Hierfür werden von dem Makefile nacheinander die Befehle \listinlsh{./configure}
und \listinlsh{make} ausgeführt. Über das Makefile kann angegeben werden, welche
...
Dieses Event wird von der Funktion \listinljava{Presenter.handleNewMessage()}
